...
public static class TelegraphClientExtension
{
    ...
    extension(ITelegraphClient telegraphClient)
    {
        /// <summary>
        ...
        public async Task<Account> CreateAccountAsync(string shortName,
        ...
        public async Task<Page> EditPageAsync(string path,
            string title,
            List<Node> content,
            string? authorName = null,
            string? authorUrl = null,
        ...
        public async Task<PageList> GetPageListAsync(int offset = 0,
            int limit = 50,
            CancellationToken cancellationToken = default
        ) =>
            await telegraphClient.MakeRequestAsync(
        ...
        public async Task<PageViews> GetViewsAsync(string path,
            int? year = null,
            int? month = null,
            int? day = null,
            int? hour = null,
        ...
        public async Task<Account> EditAccountInfoAsync(string? shortName = null,
            string? authorName = null,
            string? authorUrl = null,
            CancellationToken cancellationToken = default
        ) =>
        ...
        /// </param>
        /// <returns>Returns an <see cref="Account" /> object.</returns>
        public async Task<Account> GetAccountInfoAsync(bool shortName = false,
        ...
        /// </returns>
        public async Task<Account> RevokeAccessTokenAsync(CancellationToken cancellationToken = default
        ) =>
            await telegraphClient.MakeRequestAsync(
