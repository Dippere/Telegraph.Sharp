...
public partial class Node
{
    ...
    public static Node P(string text) => CreateNode(TagEnum.P, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node H3(string text) => CreateNode(TagEnum.H3, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node H4(string text) => CreateNode(TagEnum.H4, new List<Node>
    {
        text
    });
    ...
    public static Node A(string href) => CreateNode(TagEnum.A, attributes: new TagAttributes
    {
        Href = href
    });
    ...
    public static Node A(string href, string text) =>
        CreateNode(TagEnum.A, new List<Node>
        {
            text
        }, new TagAttributes
        {
    ...
    public static Node A(string href, IEnumerable<Node> nodes) =>
        CreateNode(TagEnum.A, nodes, new TagAttributes
        {
            Href = href
        });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node B(string text) => CreateNode(TagEnum.B, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node I(string text) => CreateNode(TagEnum.I, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Em(string text) => CreateNode(TagEnum.Em, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node U(string text) => CreateNode(TagEnum.U, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node S(string text) => CreateNode(TagEnum.S, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Code(string text) => CreateNode(TagEnum.Code, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Pre(string text) => CreateNode(TagEnum.Pre, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Strong(string text) => CreateNode(TagEnum.Strong, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Aside(string text) => CreateNode(TagEnum.Aside, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Blockquote(string text) => CreateNode(TagEnum.Blockquote, new List<Node>
    {
        text
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Li(string text) => CreateNode(TagEnum.Li, new List<Node>
    {
        text
    });
    ...
    /// <summary>
    ///     Creates a <see cref="Node" /> with tag <see cref="TagEnum.Ol" /> and given child nodes as <see cref="TagEnum.Li" />
    ///     nodes.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a <see cref="Node" /> with tag <see cref="TagEnum.Ul" /> and given child nodes as <see cref="TagEnum.Li" />
    ///     nodes.
    /// </summary>
    /// <param name="lists">Child nodes.</param>
    ...
    public static Node Img(string src) => CreateNode(TagEnum.Img, attributes: new TagAttributes
    {
        Src = src
    });
    ...
    public static Node Video(string src) => CreateNode(TagEnum.Video, attributes: new TagAttributes
    {
        Src = src
    });
    ...
    /// </summary>
    /// <param name="text">Text to be added as a child node.</param>
    public static Node Figcaption(string text) => CreateNode(TagEnum.Figcaption, new List<Node>
    {
        text
    });
    ...
    public static Node Figure(Node node, Node caption) => CreateNode(TagEnum.Figure, new List<Node>
    {
        node, caption
    });

    /// <summary>
    ///     Creates a <see cref="Node" /> with tag <see cref="TagEnum.Figure" /> with <see cref="TagEnum.Img" /> and given
    ///     child nodes.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a <see cref="Node" /> with tag <see cref="TagEnum.Figure" /> with <see cref="TagEnum.Video" /> and given
    ///     child nodes.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a <see cref="Node" /> with tag <see cref="TagEnum.Figure" /> with <see cref="TagEnum.Iframe" /> and given
    ///     child nodes.
    /// </summary>
